import { _decorator, Asset, log, resources } from 'cc';
...
export default class ResMgr {
    ...
    public existFile(path: string): boolean {
        ...
        let dirWith = resources.getDirWithPath(dirname);
